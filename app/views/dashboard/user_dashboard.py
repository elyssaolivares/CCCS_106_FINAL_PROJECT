...
def user_dashboard(page: ft.Page, user_data=None):
    ...
    if total_issues > 0:
        stats_grid = DashboardUI.create_statistics_grid(total_issues, resolved, pending, ongoing)
    ...
    def on_resize(e):
        ...
        if was_mobile != is_mobile:
            ...
            # toggle FAB
            if is_mobile:
                page.floating_action_button = DashboardUI.create_fab(report_issue_clicked)
            else:
                page.floating_action_button = None
            page.update()
