...
def user_activity_monitoring_page(page: ft.Page, user_data=None):
    ...
    # Main layout - create tabs with proper list
    main_content = ft.Column(
        [
            header,
            ft.Tabs(
                selected_index=0,
                tabs=[all_users_tab, user_detail_tab, failed_attempts_tab],
                expand=True,
            ),
        ],
        expand=True,
